...
print "Waiting for admin finger print..."
os.system('espeak -a 200 -s 120 -v en-rp "Waiting for admin finger print"')
...
print "Admin Fingerprint found!"
os.system('espeak -a 200 -s 120 -v en-rp "Admin Fingerprint found"')
...
print "Storing fingerprint at id 2"
...
rv = myFingerprintSensor.storeModel(1, 2)
if (rv != upmZfm20.ZFM20.ERR_OK):
	print "storeModel failed with error code %d" % rv
	sys.exit(1)

print " "
print "Fingerprint stored at id 2."